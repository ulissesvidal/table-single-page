function moreSettings(e, col) {
    ...
    $("div#moreSettings").css({ "top": $(window).scrollTop()+e.clientY-150+"px", "left": e.clientX-200+"px" });
...
function loadDataAjax(id, idGrid, url) {
    $.post(url+'index.php?option=com_grid&task=ajaxConfig', {
        action: "getMoreConfig",
        id: id,
        idGrid: idGrid
    }, function (data) {
        data = data.split("|");
